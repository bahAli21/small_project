...
class Services
{
    ...
    public function insertService($libelle, $descriptions, $decisionTarif, $Periode_ouverture, $Periode_fermeture): bool {
      try {
          ...
          $statement->bindParam(':descriptions', $descriptions, PDO::PARAM_STR);
          $statement->bindParam(':decisionTarif', $decisionTarif, PDO::PARAM_STR);
          $statement->bindParam(':periodeOuverture', $Periode_ouverture, PDO::PARAM_STR);
          $statement->bindParam(':periodeFermeture', $Periode_fermeture, PDO::PARAM_STR);
